  ...
  return (
    <div className="flex items-center gap-4">
      <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M33.7174 7.77038V0C50.5936 0.902991 64 14.8858 64 32C64 49.1142 50.5936 63.0931 33.7174 64V56.2296C46.2952 55.3305 56.2551 44.8124 56.2551 32C56.2551 19.1876 46.2952 8.66949 33.7174 7.77038ZM13.6349 47.8895C10.3007 44.0373 8.15151 39.1309 7.76814 33.744H0C0.402735 41.2818 3.4155 48.1221 8.13602 53.3889L13.631 47.8895H13.6349ZM30.2324 64V56.2296C24.8458 55.846 19.9433 53.6989 16.0941 50.3582L10.599 55.8576C15.8656 60.5857 22.7005 63.5969 30.2285 64H30.2324Z" fill="url(#paint0_linear_1064_14)" />
        <defs>
